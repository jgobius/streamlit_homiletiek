...
def _render_vijf_vs(data: dict) -> None:
    """Render een vijf V's dict waarvan de waarden strings of lijsten zijn."""
    for key, label in _V_LABELS.items():
        ...
        with st.expander(label, expanded=False):
            if isinstance(v, list):
                ...
                # Legacy genest formaat: kan een "beschrijving" string plus sub-lijsten bevatten
...
def waardenorientatie(analysis: dict[str, Any]) -> None:
    ...
    _render_vijf_vs(vijf_vs_plaats)
